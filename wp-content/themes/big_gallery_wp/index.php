...
<!-- page content -->
<div id="page">
	<div class="big_header"><h1 class="big_header"><?php _e( 'Blog', 'biggallery' ); ?></h1></div>
	...
	<?php if ( $blog_style == 'modern') : ?>
		...
		$count = count( $terms );
		echo '<div class="submenu" id="portfolio-filter"><span class="custom_font" style="padding-right:6px">'.__( 'Filter:', 'biggallery' ).' </span>';
		echo '<a href="#all" title="" class="custom_font">'.__('All','biggallery').'</a>&nbsp;';
					...
					<div id="posts" class="two-third classicblog2_<?php echo $content_float; ?>">
						<?php if ( have_posts() ) : ?>
							...
							<?php /* If this is a monthly archive */ } elseif ( is_month() ) { ?>
								<h2 class="margin_1line"><?php _e( 'Archive for', 'biggallery' ); ?> <?php echo get_the_time( 'F, Y' ); ?></h2>
							<?php /* If this is a yearly archive */ } elseif (is_year()) { ?>
								<h2 class="pagetitle margin_1line"><?php _e( 'Archive for', 'biggallery' ); ?> <?php echo get_the_time( 'Y' ); ?></h2>
							<?php /* If this is an author archive */ } elseif ( is_author() ) { ?>
								<h2 class="pagetitle margin_1line"><?php _e( 'Author Archive', 'biggallery' ); ?></h2>
